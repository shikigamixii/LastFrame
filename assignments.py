...
Two storage modes:
- assignments_by_provider: provider-id keyed (Tmdb/Imdb/Tvdb), survives Plex rating-key changes
- assignments: rating-key keyed fallback when no provider IDs are available
get_assigned_ids() prefers provider; falls back to item-id.
"""
from config_store import PROVIDER_PRIORITY
from db import get_db
from plex_api import get_item_providers
