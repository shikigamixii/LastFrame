...
function isWatchedByAssigned(epUsers,assignedIds){
  ...
  return rel.length>0&&rel.every(u=>u.played);const S={users:[],libraries:[],config:{},lib:null,series:null,season:null,items:{},episodes:{},assignedIds:null,selectedItemIds:new Set(),bulkAssignItems:[]};
const $=s=>document.querySelector(s),$el=()=>$("#content"),$bc=()=>$("#breadcrumbs");
